  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        {{-- si no está auenticado --}}
        @guest
          <li class="nav-item">
            <x-utils.link :href="route('frontend.auth.login')" :active="activeClass(Route::is('frontend.auth.login'))"
              :text="__('Login')" class="nav-link" />
          </li>
            ...
            <x-utils.link href="#" id="navbarDropdown" class="nav-link dropdown-toggle" role="button"
              ...
              <x-slot name="text">
                <img class="rounded-circle" style="max-height: 20px"
                  src="/storage/avatars/{{ $logged_in_user->avatar_path }}" />
